...
# gonna use the find_all method like I did yesterday - THANKS SEAN!
# it will return me an array containing only the venues that satisfy the conditions
# in the code block

my_venues = venues.find_all do |venue|
